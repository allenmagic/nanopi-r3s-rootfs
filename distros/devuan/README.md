...
sudo REPO=tsinghua PACK=1 ./distros/devuan/build.sh
...
`distros/devuan/package.list` — 三段式：
...
- 目录：`build/devuan/devuan-rootfs/`
- 打包：`build/devuan/devuan-rootfs-minimal.tar.xz`（`PACK=1`）
